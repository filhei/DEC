...
class DEC():
    ...
    def train(self, epochs = 10, learn_rate=1e-3, mini_batch_size=16):
        ...
        trainloader, valloader = self.load_mnist()
        ...
        num_mini_batches = 60000 // mini_batch_size
    ...
    def test_model(self, path="saved_models/temp_model", ):
        self.model = CNN(output_dim=2).to(self.device)
        ...
        self.evalutation_plot(images, outputs, labels)
    ...
    def scatter_plot(self, images, classes):
        ...
        plt.clf()
        plt.scatter(encodings[:,0], encodings[:,1], c=classes.squeeze())
        plt.pause(0.01)
    ...
    def save_model(self, path="saved_models/temp_model"):
...
if __name__ == "__main__":
    ...
    if train == True:
        ...
        model.train(mini_batch_size=mini_batch_size, epochs=12)
    else:
        mini_batch_size = 32
        model = DEC(mini_batch_size=mini_batch_size)
        model.test_model()
